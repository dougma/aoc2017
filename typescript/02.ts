export const input = `798	1976	1866	1862	559	1797	1129	747	85	1108	104	2000	248	131	87	95
...
function rowChecksum(row: number[]) {
    let result = 0
    for (let a = 0; a < row.length; a++) {
        for (let b = 0; b < row.length; b++) {
            if (a !== b) {
                const d = Math.abs(row[a] - row[b])
...
function rowChecksum2(row: number[]) {
    let result = 0
    for (let a = 0; a < row.length; a++) {
        for (let b = 0; b < row.length; b++) {
            if (a !== b) {
...
const result = ss.reduce((acc, row) => acc + rowChecksum2(row), 0)
console.log(result)
